...
function LogoBCA() {
    return (
        <svg viewBox="0 0 80 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-auto">
            <rect width="80" height="32" rx="4" fill="#003087"/>
            <text x="40" y="22" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold" fontFamily="Arial, sans-serif">BCA</text>
        </svg>
    );
}
...
function LogoMandiri() {
    return (
        <svg viewBox="0 0 100 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-auto">
            <rect width="100" height="32" rx="4" fill="#003087"/>
            <text x="50" y="22" textAnchor="middle" fill="#F5A623" fontSize="12" fontWeight="bold" fontFamily="Arial, sans-serif">mandiri</text>
        </svg>
    );
}
...
function LogoBNI() {
    return (
        <svg viewBox="0 0 70 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-auto">
            <rect width="70" height="32" rx="4" fill="#E46C0A"/>
            <text x="35" y="22" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold" fontFamily="Arial, sans-serif">BNI</text>
        </svg>
    );
}
...
function LogoBRI() {
    return (
        <svg viewBox="0 0 70 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-auto">
            ...
            <text x="35" y="22" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold" fontFamily="Arial, sans-serif">BRI</text>
        </svg>
    );
}
...
function LogoDana() {
    return (
        <svg viewBox="0 0 80 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-auto">
            ...
            <text x="40" y="22" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold" fontFamily="Arial, sans-serif">DANA</text>
        </svg>
    );
}
...
function LogoShopeePay() {
    return (
        <svg viewBox="0 0 110 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-auto">
            ...
            <text x="55" y="22" textAnchor="middle" fill="white" fontSize="11" fontWeight="bold" fontFamily="Arial, sans-serif">ShopeePay</text>
        </svg>
    );
}
...
function LogoGoPay() {
    return (
        <svg viewBox="0 0 80 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-auto">
            ...
            <text x="40" y="22" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold" fontFamily="Arial, sans-serif">GoPay</text>
        </svg>
    );
}
...
function LogoOVO() {
    return (
        <svg viewBox="0 0 70 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-auto">
            ...
            <text x="35" y="22" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold" fontFamily="Arial, sans-serif">ovo</text>
        </svg>
    );
}
...
function LogoLinkAja() {
    return (
        <svg viewBox="0 0 90 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-auto">
            <rect width="90" height="32" rx="16" fill="#E82529"/>
            <text x="45" y="22" textAnchor="middle" fill="white" fontSize="12" fontWeight="bold" fontFamily="Arial, sans-serif">LinkAja</text>
        </svg>
    );
}

// ─── Icon: Virtual Account category ───────────────────────────────────────────
function IconVA() {
    return (
        <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
            <rect x="2" y="5" width="20" height="14" rx="3" stroke="currentColor" strokeWidth="1.8"/>
            <path stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" d="M2 10h20"/>
            <path stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" d="M6 15h4"/>
        </svg>
    );
}

// ─── Icon: E-Wallet category ───────────────────────────────────────────────────
function IconEWallet() {
    return (
        <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
            ...
            <path stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" d="M16 12h2"/>
            <path stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" d="M3 7V6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v1"/>
        </svg>
    );
}
...
export default function PaymentModal({ show, paymentMethod, setPaymentMethod, closeModal }: Props) {
            ...
            >
                ...
                <div className="flex items-center gap-3 border-b border-gray-100 px-5 pt-4 pb-4">
                    ...
                    <div className="flex-1">
                        ...
                        {!paymentType && (
                            <p className="mt-0.5 text-xs text-gray-400">Pilih jenis pembayaran yang diinginkan</p>
                        )}
                    </div>

                    <button
                        onClick={handleClose}
                        className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 hover:bg-gray-200 transition text-gray-500"
                    >
                ...
                <div className="p-5 pb-6">
                    ...
                    {!paymentType && (
                        <div className="fade-in space-y-3">
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <p className="text-sm font-semibold text-gray-900">Virtual Account</p>
                                    <div className="mt-1.5 flex items-center gap-2">
                                        <LogoBCA /><LogoMandiri /><LogoBNI /><LogoBRI />
                                    </div>
                                </div>
                                <svg className="h-4 w-4 shrink-0 text-gray-300 transition group-hover:text-teal-500" fill="none" viewBox="0 0 24 24">
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="mt-1.5 flex items-center gap-2 flex-wrap">
                                        <LogoDana /><LogoShopeePay /><LogoGoPay /><LogoOVO /><LogoLinkAja />
                                    </div>
                                </div>
                                <svg className="h-4 w-4 shrink-0 text-gray-300 transition group-hover:text-teal-500" fill="none" viewBox="0 0 24 24">
                                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"/>
                    ...
                    {paymentType === 'va' && (
                        <div className="fade-in space-y-2">
                            {PAYMENT_OPTIONS.va.map(({ id, label, Logo }) => (
                                <button
                                    key={id}
                                    onClick={() => { setPaymentMethod(id); handleClose(); }}
                                    className={`flex w-full items-center gap-4 rounded-xl border px-4 py-3.5 text-sm font-medium transition ${
                                        paymentMethod === id
                                            ? 'border-teal-400 bg-teal-50 ring-2 ring-teal-100'
                                            : 'border-gray-200 bg-gray-50 hover:border-teal-300 hover:bg-teal-50'
                                    }`}
                                >
                                    <div className="flex h-9 w-16 shrink-0 items-center justify-center rounded-lg bg-white shadow-sm border border-gray-100 px-1">
                                        <Logo />
                                    </div>
                                    <span className="flex-1 text-left text-gray-800">{label}</span>
                                    {paymentMethod === id && (
                                        <svg className="h-4 w-4 shrink-0 text-teal-500" fill="none" viewBox="0 0 24 24">
                    ...
                    {paymentType === 'ewallet' && (
                        <div className="fade-in space-y-2">
                            {PAYMENT_OPTIONS.ewallet.map(({ id, label, Logo }) => (
                                <button
                                    key={id}
                                    onClick={() => { setPaymentMethod(id); handleClose(); }}
                                    className={`flex w-full items-center gap-4 rounded-xl border px-4 py-3.5 text-sm font-medium transition ${
